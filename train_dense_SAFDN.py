...
def run(args):
    ...
    criterion = nn.CrossEntropyLoss().to(device)  # modified
    # optimizer = optim.Adam(model.parameters(), lr=args.lr)
    # optimizer = optim.Adam(model.parameters(), betas=(0.9, 0.999), eps=1e-8)    # denoising_code
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epochs', type=int, default=46,
                        help='number of epochs to train')
    parser.add_argument('--lr', type=float, default=8e-4,
                        help='learning rate')
    parser.add_argument('--seed', type=int, default=123,
                        help='manual seed')
    parser.add_argument('--output-dir', default='checkpoints_PPliteseg_both',
    ...
    parser.add_argument("--dataset-dir", type=str, default="/home/tony/github/PointCloudDenoising/cnn_denoising/",
