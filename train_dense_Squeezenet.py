...
if __name__ == '__main__':
    ...
    parser.add_argument('--seed', type=int, default=123,
                        help='manual seed')
    parser.add_argument('--output-dir', default='checkpoints_squeezeseg',
                        help='directory to save model checkpoints')
    parser.add_argument('--resume', type=str, metavar='PATH',default='checkpoints_squeezeseg/checkpoint_epoch20_mIoU=70.2.pth',
